 ...
 */
package br.com.vedoy.relatorios;
...
public class Relatorio {
    ...
    */
    public void getRelatorio(List<Ordem_Servicos> lista){
        stream = this.getClass().getResourceAsStream("C:\\Users\\Fabio Vedoy\\Documents\\NetBeansProjects\\OSWEBTCC\\src\\java\\relatorio\\RelOS.jasper");
    ...
    public Connection getConexao(){        
        try {            
            ...
            con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/OST", "postgres", "adm");
            return con;
